...
package pl.brun.lib.test.actions {
	 ...
	 * @author Marek Brun
	 */
	public class AnimCircleAction extends MCPlayToEndAndBackAction {

		public function AnimCircleAction(mc:MovieClip) {
			super(mc);
		}
		...
		override protected function getActionByPatchName(patchName:String):Action {
			switch(patchName) {
				case 'red':
					return new MCPlayToEndAndBackAction(new AnimTriangleRedMC());
					break;
				case 'green':
					return new MCPlayToEndAndBackAction(new AnimTriangleGreenMC());
					break;
				case 'blue':
					return new MCPlayToEndAndBackAction(new AnimTriangleBlueMC());
					break;
			}
