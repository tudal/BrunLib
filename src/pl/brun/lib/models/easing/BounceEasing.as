...
package pl.brun.lib.models.easing {
	...
	public class BounceEasing extends Easing {
		...
		override protected function calculateEasing(input:Number):Number {
			return bounce(input, humps, power, friction);
		}

		public static function bounce(n:Number, humps:Number, power:Number, friction:Number):Number {
