...
package pl.brun.lib.models.easing {
	 ...
	 * @author Marek Brun
	 */
	public class Bezier2Easing extends Easing {
		...
		override protected function calculateEasing(input:Number):Number {
			return 1 - bezier(input, 0, one, two, 1);
		}

		private function bezier(cou:Number, n1:Number, n2:Number, n3:Number, n4:Number):Number {
			return	n1 * bezier1(cou) + n2 * bezier2(cou) + n3 * bezier3(cou) + n4 * bezier4(cou);
		}
