package pl.brun.lib.debugger.model.content {
	 ...
	 * @author Marek Brun
	 */
	public class BDVectorListModel extends Base implements IBDTextContentProvider, IBDRefreshable {

		private var text:String;
		private var links:BDTextsManager;
		private var arrRID:uint;

		public function BDVectorListModel(arr:*, links:BDTextsManager) {
			this.links = links;
		...
		public function refresh():void {
			...
			var arr:* = links.weaks.getValue(arrRID);
